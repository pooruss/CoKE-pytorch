...
def create_args():
    ...
    model_g.add_arg("activation_dropout", float, 0.2, "CoKE model config: attention_probs_dropout_prob, default 0.1")
    ...
    train_g.add_arg("learning_rate", float, 4e-3, "Learning rate used to train with warmup.")
